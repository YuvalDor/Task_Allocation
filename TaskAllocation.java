...
public class TaskAllocation{
    ...
    public void addTask(Task c){
        TaskElement newTask = new TaskElement(c);
        heap.insert(newTask);
        q.enqueue(newTask);
    }
    ...
    public Task allocatePriorityTask(){
        TaskElement topPriority = heap.extractMax();
        TaskElement prevPriority = topPriority.prev;
        TaskElement nextPriority = topPriority.next;
        ...
        if ((prevPriority == null) & (nextPriority == null)){
            ...
            nextPriority.prev = prevPriority;
            prevPriority.next = topPriority.next;
        }
        return topPriority.t;
    }
    ...
    public Task allocateRegularTask(){
        TaskElement topPriority = q.dequeue(); //removeFirst - Queue removal
        heap.remove(topPriority.heapIndex);    // Heap removal
        return topPriority.t;
    }
